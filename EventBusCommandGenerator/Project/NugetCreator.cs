namespace OliveGenerator
{
    ...
    class NugetCreator
    {
        ...
        FileInfo CreateNugetPackage()
        {
            ...
            return NuspecFile.Directory.GetFiles(NuspecFile.NameWithoutExtension().TrimEnd(".Command") + "*.nupkg").FirstOrDefault()
...
<package xmlns=""http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd"">
  <metadata>
    ...
    <description>Provides an easy method to invoke the Api functions of {Context.CommandName}</description>
    <dependencies>
