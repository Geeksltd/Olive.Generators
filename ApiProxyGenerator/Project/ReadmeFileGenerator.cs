...
namespace OliveGenerator
{
    internal class ReadmeFileGenerator
    {
        internal static string Generate()
        {
            ...
            r.AppendLine($"The {Context.Current.ControllerType.FullName}.Proxy package is generated by « Olive Api Proxy Generator ».");
            r.AppendLine();
        ...
        static string GenerateQuickReference()
        {
            ...
            var methods = Context.Current.ActionMethods.Select(x => x.Method);
            ...
            foreach (var method in methods)
            {
                ...
                r.Append("await ");
                r.Append(Context.Current.ControllerType.FullName + ".Fresh().");
        ...
        static string GenerateProxyConfig()
        {
            ...
            r.AppendLine();
            r.AppendLine(Context.Current.ControllerType.FullName);
            ...
            r.AppendLine("    " + Context.Current.ControllerType.FullName + ".Fast()");
            r.AppendLine();
            ...
            r.AppendLine("You can obtain an instance of the Api that is preconfigured for that by using:");
            r.AppendLine("    " + Context.Current.ControllerType.FullName + ".Fresh()");
            return r.ToString();
        }
        ...
        static string GenerateDataProviders()
        {
            var dataProviders = DtoTypes.All
             .Where(x => new DtoDataProviderClassGenerator(x, Context.Current).Generate().HasValue()).ToList();
